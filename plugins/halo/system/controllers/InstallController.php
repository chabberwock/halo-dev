...
namespace halo\system\controllers;

use halo\system\install\DbConfig;
use halo\system\install\Plugins;
use halo\system\MigrationWrapper;
use Yii;
...
class InstallController extends \yii\web\Controller
{
    ...
    public function actionPlugins()
    {
        ...
        if ($model->load(Yii::$app->request->post()) && $model->validate()) {
            ...
            return $this->redirect(['/halo.system/install/migrate']);
        }
    ...
    public function actionDb()
    {
        ...
        if ($model->load(\Yii::$app->request->post()) && $model->validate()) {
            ...
            return $this->redirect(['/halo.system/install/plugins']);        
        }
